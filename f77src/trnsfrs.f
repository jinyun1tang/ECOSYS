...
C
      TORTL=AMIN1(1.0,(TORT(M,0,NY,NX)*DLYR(3,0,NY,NX)
     2+TORT(M,NU(NY,NX),NY,NX)*DLYR(3,NU(NY,NX),NY,NX))
...
C     DIFFUSIVITIES IN CURRENT AND ADJACENT GRID CELL MICROPORES
C
      TORTL=(TORT(M,N3,N2,N1)*DLYR(N,N3,N2,N1)
     2+TORT(M,N6,N5,N4)*DLYR(N,N6,N5,N4))
...
C
      TORTL=(TORTH(M,N3,N2,N1)*DLYR(N,N3,N2,N1)
     2+TORTH(M,N6,N5,N4)*DLYR(N,N6,N5,N4))
     3/(DLYR(N,N3,N2,N1)+DLYR(N,N6,N5,N4))
