...
C
      ...
      CALW=ZALW(NY,NX)*VFLWW
      CFEW=ZFEW(NY,NX)*VFLWW
      CHYW=ZHYW(NY,NX)*VFLWW
      CCAW=ZCAW(NY,NX)*VFLWW
      CMGW=ZMGW(NY,NX)*VFLWW
      CNAW=ZNAW(NY,NX)*VFLWW
      CKAW=ZKAW(NY,NX)*VFLWW
      COHW=ZOHW(NY,NX)*VFLWW
      CSOW=ZSO4W(NY,NX)*VFLWW
      CCLW=ZCLW(NY,NX)*VFLWW
      CC3W=ZCO3W(NY,NX)*VFLWW
      CHCW=ZHCO3W(NY,NX)*VFLWW
      CAL1W=ZALH1W(NY,NX)*VFLWW
      CAL2W=ZALH2W(NY,NX)*VFLWW
      CAL3W=ZALH3W(NY,NX)*VFLWW
      CAL4W=ZALH4W(NY,NX)*VFLWW
      CALSW=ZALSW(NY,NX)*VFLWW
      CFE1W=ZFEH1W(NY,NX)*VFLWW
      CFE2W=ZFEH2W(NY,NX)*VFLWW
      CFE3W=ZFEH3W(NY,NX)*VFLWW
      CFE4W=ZFEH4W(NY,NX)*VFLWW
      CFESW=ZFESW(NY,NX)*VFLWW
      CCAOW=ZCAOW(NY,NX)*VFLWW
      CCACW=ZCACW(NY,NX)*VFLWW
      CCAHW=ZCAHW(NY,NX)*VFLWW
      CCASW=ZCASW(NY,NX)*VFLWW
      CMGOW=ZMGOW(NY,NX)*VFLWW
      CMGCW=ZMGCW(NY,NX)*VFLWW
      CMGHW=ZMGHW(NY,NX)*VFLWW
      CMGSW=ZMGSW(NY,NX)*VFLWW
      CNACW=ZNACW(NY,NX)*VFLWW
      CNASW=ZNASW(NY,NX)*VFLWW
      CKASW=ZKASW(NY,NX)*VFLWW
      CH0PW=H0PO4W(NY,NX)*VFLWW
      CH3PW=H3PO4W(NY,NX)*VFLWW
      CF1PW=ZFE1PW(NY,NX)*VFLWW
      CF2PW=ZFE2PW(NY,NX)*VFLWW
      CC0PW=ZCA0PW(NY,NX)*VFLWW
      CC1PW=ZCA1PW(NY,NX)*VFLWW
      CC2PW=ZCA2PW(NY,NX)*VFLWW
      CM1PW=ZMG1PW(NY,NX)*VFLWW
...
C     WRITE(*,443)'ZOHW2',I,J,NX,NY,ZOHW(NY,NX)
C    2,XOHBLS(NY,NX),ZOHW2(NY,NX),COHW,PRECQ(NY,NX)
C    2,COHR(NY,NX),PRECI(NY,NX),COHQ(I,NY,NX)
C    3,FLQTM,ZOHW(NY,NX),VFLWW,FLQGM(NY,NX),FLQRM(NY,NX)
443   FORMAT(A8,4I4,20E12.4)
...
C
C     HOURLY SOLUTE FLUXES FROM SOLUTE.F 
C
...
C     IF(I.EQ.268)THEN
C     WRITE(*,4444)'ROHFLS',I,J,M,NX,NY
C    2,ROHFLS(3,NU(NY,NX),NY,NX),ROHFL1,RFLOH,DFVOH
C    3,XOHFLS(3,NU(NY,NX),NY,NX),FLQGQ(NY,NX),COHR(NY,NX)
C    4,FLQGI(NY,NX),COHQ(I,NY,NX),COHW,VFLWG,FLQTM,ZOHW(NY,NX),VFLWW
4444  FORMAT(A8,5I4,20E12.4)
C     ENDIF 
C
C     ACCUMULATE HOURLY FLUXES
C
...
C
      ...
      VFLW=AMAX1(0.0,AMIN1(VFLWX,QRM(M,N,N5,N4)
     2/VOLWM(M,0,N2,N1)))
      ELSE
      VFLW=VFLWX
      ENDIF
...
C
      ...
      VFLW=AMIN1(0.0,AMAX1(-VFLWX,QRM(M,N,N5,N4)
     2/VOLWM(M,0,N5,N4)))
      ELSE
      VFLW=-VFLWX
      ENDIF
