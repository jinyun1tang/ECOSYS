     ...
     7,XER(JY,JX),SLOPE(3,JY,JX),CDPTHI(JY,JX),BKDSM(JZ,JY,JX)
     8,NU(JY,JX),NUI(JY,JX),NJ(JY,JX),NK(JY,JX),NLI(JV,JH),NL(JV,JH)
     9,ISOILR(JY,JX),NW(JY,JX),NHOL(JZ,JY,JX),NUM(JY,JX)
