      COMMON/BLK8A/PSIFC(JY,JX),PSIWP(JY,JX),FMPR(JZ,JY,JX)
     1,ALBS(JY,JX),DPTHS(JY,JX),CDPTH(0:JZ,JY,JX),ROCK(JZ,JY,JX)
     2,BKDS(JZ,JY,JX),FC(JZ,JY,JX),WP(JZ,JY,JX),SCNV(JZ,JY,JX)
     3,SCNH(JZ,JY,JX),CSAND(JZ,JY,JX),CSILT(JZ,JY,JX),CCLAY(JZ,JY,JX)
     4,FHOL(JZ,JY,JX),PHOL(JZ,JY,JX),DHOL(JZ,JY,JX),HRAD(JZ,JY,JX) 
     5,BKDX(JZ,JY,JX),PH(0:JZ,JY,JX),CEC(JZ,JY,JX),AEC(JZ,JY,JX)
     ...
     7,XER(JY,JX),SLOPE(3,JY,JX),CDPTHI(JY,JX),NU(JY,JX),NUI(JY,JX)
     8,NJ(JY,JX),NK(JY,JX),NL(JV,JH),ISOILR(JY,JX),NW(JY,JX)
     9,NHOL(JZ,JY,JX),NUM(JY,JX)
