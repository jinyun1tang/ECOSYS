...
240   CONTINUE
     ...
     5+0.5*DV(NY-1,N)*SLOPE(2,NY-1,NX))/2.0
      ...
      ENDIF
C     WRITE(18,1111)'ALT',NX,NY,ALT(NY,NX)
C    2,DH(NY,NX),DV(NY,NX),ASP(NY,NX),GSIN(NY,NX)
C    3,SLOPE(1,NY,NX),SLOPE(2,NY,NX)
...
C
      ...
      WRITE(*,5432)'PART',L,FC0,FC1,FCX,HCX,TORGM,TORGL(L) 
