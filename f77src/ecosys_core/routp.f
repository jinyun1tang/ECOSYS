...
8000  CONTINUE
      ...
      DO 9975 NZ=1,NPP(NY,NX)
      READ(26,90)IDATE,IYR,IFLGC(NZ,NY,NX),IDTH(NZ,NY,NX) 
9975  CONTINUE
      DO 9976 NZ=1,NPP(NY,NX)
      READ(26,97)IDATE,IYR
...
9976  CONTINUE
     ...
     2,TZUPTK(NZ,NY,NX),TZSNC(NZ,NY,NX),TPUPTK(NZ,NY,NX)
     3,TPSNC(NZ,NY,NX),TZUPFX(NZ,NY,NX),TCO2T(NZ,NY,NX)
     4,CTRAN(NZ,NY,NX),CARBN(NZ,NY,NX)
     5,TCC(NZ,NY,NX),TKC(NZ,NY,NX),TCG(NZ,NY,NX),TKG(NZ,NY,NX)
     6,TFN3(NZ,NY,NX),WVSTK(NZ,NY,NX),VOLWP(NZ,NY,NX),DWTSHT(NZ,NY,NX)
     7,PSILT(NZ,NY,NX),PSILO(NZ,NY,NX),PSILG(NZ,NY,NX),WTRTA(NZ,NY,NX)
     8,ARLFP(NZ,NY,NX),ARSTP(NZ,NY,NX),HVSTC(NZ,NY,NX)
     9,HVSTN(NZ,NY,NX),HVSTP(NZ,NY,NX),THVSTC(NZ,NY,NX)
     1,THVSTN(NZ,NY,NX),THVSTP(NZ,NY,NX),TCO2A(NZ,NY,NX)
     2,RSETC(NZ,NY,NX),RSETN(NZ,NY,NX),RSETP(NZ,NY,NX)
     3,TNH3C(NZ,NY,NX),TCSN0(NZ,NY,NX),PPI(NZ,NY,NX),PPZ(NZ,NY,NX)  
     4,PPX(NZ,NY,NX),DPP(NZ,NY,NX),WTSTG(NZ,NY,NX),WTSTGN(NZ,NY,NX) 
     5,WTSTGP(NZ,NY,NX),ZC(NZ,NY,NX),ZG(NZ,NY,NX),VOLWC(NZ,NY,NX) 
     6,VOLWQ(NZ,NY,NX),HCBFCZ(NZ,NY,NX),HCBFDZ(NZ,NY,NX)
     7,VCOXF(NZ,NY,NX),VNOXF(NZ,NY,NX),VPOXF(NZ,NY,NX)
     8,TKQC(NZ,NY,NX),VPQC(NZ,NY,NX),CF(NZ,NY,NX),ARSTG(NZ,NY,NX)
      ...
      READ(26,92)IDATE,IYR,NZ,(FLGQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
...
9955  READ(26,95)IDATE,IYR,NZ,(IDAY(N,NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
     ...
     8,HEAT(NZ,NY,NX),WTRTS(NZ,NY,NX),FRADP(NZ,NY,NX) 
      ...
      READ(27,94)IDATE,IYR,NZ,(ARSTD(L,NZ,NY,NX),L=1,JC)
      IF(ISALTG.NE.0)THEN
      READ(27,92)IDATE,IYR,NZ,(ZALQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      READ(27,92)IDATE,IYR,NZ,(ZFEQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      READ(27,92)IDATE,IYR,NZ,(ZCAQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      READ(27,92)IDATE,IYR,NZ,(ZMGQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      READ(27,92)IDATE,IYR,NZ,(ZNAQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      READ(27,92)IDATE,IYR,NZ,(ZKAQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      READ(27,92)IDATE,IYR,NZ,(ZSOQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      READ(27,92)IDATE,IYR,NZ,(ZCLQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      ENDIF
...
9945  CONTINUE
      ...
      READ(29,92)IDATE,IYR,NZ,PORT(N,NZ,NY,NX)
...
9970  CONTINUE
      ...
      IF(ISALTG.NE.0)THEN
      DO 9960 N=1,MY(NZ,NY,NX)
      READ(29,94)IDATE,IYR,NZ,(ZALR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      READ(29,94)IDATE,IYR,NZ,(ZFER(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      READ(29,94)IDATE,IYR,NZ,(ZCAR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      READ(29,94)IDATE,IYR,NZ,(ZMGR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      READ(29,94)IDATE,IYR,NZ,(ZNAR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      READ(29,94)IDATE,IYR,NZ,(ZKAR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      READ(29,94)IDATE,IYR,NZ,(ZSOR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      READ(29,94)IDATE,IYR,NZ,(ZCLR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
9960  CONTINUE
      ENDIF
      ENDIF
9980  CONTINUE
...
9875  CONTINUE
C
C     RESET UNUSED BRANCHES
C
C     IF(IFLGT(NY,NX).GT.0)THEN
      DO 9880 NZ=1,NP(NY,NX)
C     IF(IFLGC(NZ,NY,NX).EQ.1)THEN
C     IF(NBR(NZ,NY,NX).LT.JB)THEN
      IF(IFLGC(NZ,NY,NX).EQ.0
     2.OR.(IFLGC(NZ,NY,NX).EQ.1.AND.NBR(NZ,NY,NX).LT.JB))THEN
...
5     CONTINUE
      IF(ISALTG.NE.0)THEN
      ZALQ(NB,NZ,NY,NX)=0.0
      ZFEQ(NB,NZ,NY,NX)=0.0
      ZCAQ(NB,NZ,NY,NX)=0.0
      ZMGQ(NB,NZ,NY,NX)=0.0
      ZNAQ(NB,NZ,NY,NX)=0.0
      ZKAQ(NB,NZ,NY,NX)=0.0
      ZSOQ(NB,NZ,NY,NX)=0.0
      ZCLQ(NB,NZ,NY,NX)=0.0
      ENDIF
9600  CONTINUE
      DO 9610 NB=NBRX,JB
      DO 9620 K=0,25
...
9610  CONTINUE
      ENDIF
C
C     RESET UNUSED ROOT AXES
C
      IF(IFLGC(NZ,NY,NX).EQ.0
     2.OR.(IFLGC(NZ,NY,NX).EQ.1.AND.NRT(NZ,NY,NX).LT.10))THEN
      IF(IFLGC(NZ,NY,NX).EQ.0)THEN
      NRTX=1
      ELSE
      NRTX=NRT(NZ,NY,NX)+1
...
C     WRITE(*,3115)'ROUTP4'
C    2,(IFLGC(NZ,1,1),NZ=1,3)
C    2,(PPX(NZ,1,1),NZ=1,3)
C    3,(PPZ(NZ,1,1),NZ=1,3)
3115  FORMAT(A8,3I4,6E12.4)
      GO TO 1000
      ELSE
      CALL STARTQ(NHW,NHE,NVN,NVS,1,5)
      GO TO 1000
