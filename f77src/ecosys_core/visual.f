...
C
C     WRITE(19,2025)'FLUXES',IYRC,I,J,TTRN*277.8/TAREA
C    2,TTLE*277.8/TAREA,TTSH*277.8/TAREA,TTGH*277.8/TAREA
C    3,TTCO*23.14815/TAREA,TTCH*23.14815/TAREA
C    4,((TCNET(NY,NX)/AREA(3,NU(NY,NX),NY,NX)*23.14815
C    5,NX=NHW,NHE),NY=NVN,NVS),DEFAULT
C    8,((HCH4G(NY,NX)/AREA(3,NU(NY,NX),NY,NX)*23.14815
C    5,NX=NHW,NHE),NY=NVN,NVS)
2025  FORMAT(A16,3I6,100E12.4)
C     IF(J.EQ.24)THEN
C     WRITE(20,2026)'SWC',IYRC,I,J,((DPTHS(NY,NX)
C    2,NX=NHW,NHE),NY=NVN,NVS),DEFAULT 
C    3,((SWC(NY,NX),NX=NHW,NHE),NY=NVN,NVS),DEFAULT
C    3,((-(DPTHA(NY,NX)-CDPTH(NU(NY,NX)-1,NY,NX))
C    4,NX=NHW,NHE),NY=NVN,NVS)
