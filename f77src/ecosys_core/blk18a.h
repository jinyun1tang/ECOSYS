     ...
     1,TUPH2B(JZ,JY,JX),TUPNF(JZ,JY,JX),CSNT(5,0:1,0:JZ,JY,JX)
     2,ZSNT(5,0:1,0:JZ,JY,JX),PSNT(5,0:1,0:JZ,JY,JX)
     ...
     8,TCCAN(JY,JX),XCNET(JY,JX),XHNET(JY,JX),XONET(JY,JX) 
     9,TUPH1P(JZ,JY,JX),TUPH1B(JZ,JY,JX),ARSDC(JY,JX),ARSDT(JC,JY,JX) 
     1,TEVPPH(JY,JX),CSNMT(4,JY,JX),ZSNMT(4,JY,JX),PSNMT(4,JY,JX) 
     2,ZSNIT(JY,JX),PSNIT(JY,JX),ZCNET(JY,JX),ZHNET(JY,JX),ZONET(JY,JX)
