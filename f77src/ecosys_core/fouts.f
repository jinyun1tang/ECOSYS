...
1021  CONTINUE
      ...
      IF(L.EQ.2)HEAD(M)='SURF_RUNOFF'
      IF(L.EQ.3)HEAD(M)='SURF_SEDIMENT'
      IF(L.EQ.4)HEAD(M)='TTL_SWC'
      IF(L.EQ.5)HEAD(M)='SURF_DISCHG'
      IF(L.EQ.6)HEAD(M)='SURF_SNOWPACK'
      IF(L.EQ.7)HEAD(M)='SURF_WTR_1'
      IF(L.EQ.8)HEAD(M)='SURF_WTR_2'
      IF(L.EQ.9)HEAD(M)='SURF_WTR_3'
      IF(L.EQ.10)HEAD(M)='SURF_WTR_4'
      IF(L.EQ.11)HEAD(M)='SURF_WTR_5'
      IF(L.EQ.12)HEAD(M)='SURF_WTR_6'
      IF(L.EQ.13)HEAD(M)='SURF_WTR_7'
      IF(L.EQ.14)HEAD(M)='SURF_WTR_8'
      IF(L.EQ.15)HEAD(M)='SURF_WTR_9'
      IF(L.EQ.16)HEAD(M)='SURF_WTR_10'
      IF(L.EQ.17)HEAD(M)='SURF_WTR_11'
      IF(L.EQ.18)HEAD(M)='SURF_WTR_12'
      IF(L.EQ.19)HEAD(M)='SURF_WTR_13'
      IF(L.EQ.20)HEAD(M)='SURF_WTR_14'
      IF(L.EQ.21)HEAD(M)='SURF_WTR_15'
      IF(L.EQ.22)HEAD(M)='SURF_WTR_16'
      IF(L.EQ.23)HEAD(M)='SURF_WTR_17'
      IF(L.EQ.24)HEAD(M)='SURF_WTR_18'
      IF(L.EQ.25)HEAD(M)='SURF_WTR_19'
      IF(L.EQ.26)HEAD(M)='SURF_WTR_20'
      IF(L.EQ.27)HEAD(M)='SURF_WTR'
      IF(L.EQ.28)HEAD(M)='SURF_ICE_1'
      IF(L.EQ.29)HEAD(M)='SURF_ICE_2'
      IF(L.EQ.30)HEAD(M)='SURF_ICE_3'
      IF(L.EQ.31)HEAD(M)='SURF_ICE_4'
      IF(L.EQ.32)HEAD(M)='SURF_ICE_5'
      IF(L.EQ.33)HEAD(M)='SURF_ICE_6'
      IF(L.EQ.34)HEAD(M)='SURF_ICE_7'
      IF(L.EQ.35)HEAD(M)='SURF_ICE_8'
      IF(L.EQ.36)HEAD(M)='SURF_ICE_9'
      IF(L.EQ.37)HEAD(M)='SURF_ICE_10'
      IF(L.EQ.38)HEAD(M)='SURF_ICE_11'
      IF(L.EQ.39)HEAD(M)='SURF_ICE_12'
      IF(L.EQ.40)HEAD(M)='SURF_ICE_13'
      IF(L.EQ.41)HEAD(M)='SURF_ICE_14'
      IF(L.EQ.42)HEAD(M)='SURF_ICE_15'
      IF(L.EQ.43)HEAD(M)='SURF_ICE_16'
      IF(L.EQ.44)HEAD(M)='SURF_ICE_17'
      IF(L.EQ.45)HEAD(M)='SURF_ICE_18'
      IF(L.EQ.46)HEAD(M)='SURF_ICE_19'
      IF(L.EQ.47)HEAD(M)='SURF_ICE_20'
...
1026  CONTINUE
      ...
      IF(L.EQ.8)HEAD(M)='SOIL_WTR_2'
      IF(L.EQ.9)HEAD(M)='SOIL_WTR_3'
      IF(L.EQ.10)HEAD(M)='SOIL_WTR_4'
      IF(L.EQ.11)HEAD(M)='SOIL_WTR_5'
      IF(L.EQ.12)HEAD(M)='SOIL_WTR_6'
      IF(L.EQ.13)HEAD(M)='SOIL_WTR_7'
      IF(L.EQ.14)HEAD(M)='SOIL_WTR_8'
      IF(L.EQ.15)HEAD(M)='SOIL_WTR_9'
      IF(L.EQ.16)HEAD(M)='SOIL_WTR_10'
      IF(L.EQ.17)HEAD(M)='SOIL_WTR_11'
      IF(L.EQ.18)HEAD(M)='SOIL_WTR_12'
      IF(L.EQ.19)HEAD(M)='SOIL_WTR_13'
      IF(L.EQ.20)HEAD(M)='SOIL_SURF_WTR'
      IF(L.EQ.21)HEAD(M)='SOIL_ICE_1'
      IF(L.EQ.22)HEAD(M)='SOIL_ICE_2'
      IF(L.EQ.23)HEAD(M)='SOIL_ICE_3'
      IF(L.EQ.24)HEAD(M)='SOIL_ICE_4'
      IF(L.EQ.25)HEAD(M)='SOIL_ICE_5'
      IF(L.EQ.26)HEAD(M)='SOIL_ICE_6'
      IF(L.EQ.27)HEAD(M)='SOIL_ICE_7'
      IF(L.EQ.28)HEAD(M)='SOIL_ICE_8'
      IF(L.EQ.29)HEAD(M)='SOIL_ICE_9'
      IF(L.EQ.30)HEAD(M)='SOIL_ICE_10'
      IF(L.EQ.31)HEAD(M)='SOIL_ICE_11'
      IF(L.EQ.32)HEAD(M)='SOIL_ICE_12'
      IF(L.EQ.33)HEAD(M)='SOIL_ICE_13'
      ...
      IF(L.EQ.46)HEAD(M)='SOIL_SEDIMENT'
      IF(L.EQ.47)HEAD(M)='PSI_SURF'
      IF(L.EQ.48)HEAD(M)='SURF_ELEV'
      IF(L.EQ.49)HEAD(M)='SOIL_ACTV_LYR'
      IF(L.EQ.50)HEAD(M)='SOIL_WTR_TBL'
      ENDIF
1027  CONTINUE
      NOUTS(N-20)=M
      ENDIF
