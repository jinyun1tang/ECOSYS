...
C
      ...
      if(K.EQ.33)HEAD(M)=TOMLS(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.34)HEAD(M)=TOMLD(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.35)HEAD(M)=OQCLT(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.36)HEAD(M)=OQALT(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
