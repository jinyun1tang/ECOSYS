...
C
      ...
      IF(K.EQ.17)HEAD(M)=(VCO2G(NY,NX)+VCO2R(NY,NX))
     2/AREA(3,NU(NY,NX),NY,NX)
      ...
      IF(K.EQ.32)HEAD(M)=VCOXFS(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.33)HEAD(M)=ZCNET(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.34)HEAD(M)=ZHNET(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.35)HEAD(M)=ZONET(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      ...
      IF(K.EQ.48)HEAD(M)=(VCH4G(NY,NX)+VCH4R(NY,NX))
     2/AREA(3,NU(NY,NX),NY,NX)
...
C
      ...
      IF(K.EQ.19)HEAD(M)=THETWZ(14,NY,NX)
      ...
      IF(K.EQ.45)HEAD(M)=1000.0*UVOLY(NY,NX)/TAREA 
      IF(K.EQ.46)HEAD(M)=1000.0*USEDOU(NY,NX)/TAREA
      IF(K.EQ.47)HEAD(M)=PSISM(0,NY,NX) 
      IF(K.EQ.48)HEAD(M)=-CDPTH(NU(NY,NX)-1,NY,NX)
     2+DLYR(3,0,NY,NX)
...
C
     ...
     2+14.0*(XN4(1,NY,NX)+XNB(1,NY,NX)))/BKVL(1,NY,NX)
      ELSEIF(VOLW(1,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(1,NY,NX)+ZNH4B(1,NY,NX)
     2+14.0*(XN4(1,NY,NX)+XNB(1,NY,NX)))/VOLW(1,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(2,NY,NX)+XNB(2,NY,NX)))/BKVL(2,NY,NX)
      ELSEIF(VOLW(2,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(2,NY,NX)+ZNH4B(2,NY,NX)
     2+14.0*(XN4(2,NY,NX)+XNB(2,NY,NX)))/VOLW(2,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(3,NY,NX)+XNB(3,NY,NX)))/BKVL(3,NY,NX)
      ELSEIF(VOLW(3,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(3,NY,NX)+ZNH4B(3,NY,NX)
     2+14.0*(XN4(3,NY,NX)+XNB(3,NY,NX)))/VOLW(3,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(4,NY,NX)+XNB(4,NY,NX)))/BKVL(4,NY,NX)
      ELSEIF(VOLW(4,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(4,NY,NX)+ZNH4B(4,NY,NX)
     2+14.0*(XN4(4,NY,NX)+XNB(4,NY,NX)))/VOLW(4,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(5,NY,NX)+XNB(5,NY,NX)))/BKVL(5,NY,NX)
      ELSEIF(VOLW(5,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(5,NY,NX)+ZNH4B(5,NY,NX)
     2+14.0*(XN4(5,NY,NX)+XNB(5,NY,NX)))/VOLW(5,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(6,NY,NX)+XNB(6,NY,NX)))/BKVL(6,NY,NX)
      ELSEIF(VOLW(6,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(6,NY,NX)+ZNH4B(6,NY,NX)
     2+14.0*(XN4(6,NY,NX)+XNB(6,NY,NX)))/VOLW(6,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(7,NY,NX)+XNB(7,NY,NX)))/BKVL(7,NY,NX)
      ELSEIF(VOLW(7,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(7,NY,NX)+ZNH4B(7,NY,NX)
     2+14.0*(XN4(7,NY,NX)+XNB(7,NY,NX)))/VOLW(7,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(8,NY,NX)+XNB(8,NY,NX)))/BKVL(8,NY,NX)
      ELSEIF(VOLW(8,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(8,NY,NX)+ZNH4B(8,NY,NX)
     2+14.0*(XN4(8,NY,NX)+XNB(8,NY,NX)))/VOLW(8,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(9,NY,NX)+XNB(9,NY,NX)))/BKVL(9,NY,NX)
      ELSEIF(VOLW(9,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(9,NY,NX)+ZNH4B(9,NY,NX)
     2+14.0*(XN4(9,NY,NX)+XNB(9,NY,NX)))/VOLW(9,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(10,NY,NX)+XNB(10,NY,NX)))/BKVL(10,NY,NX)
      ELSEIF(VOLW(10,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(10,NY,NX)+ZNH4B(10,NY,NX)
     2+14.0*(XN4(10,NY,NX)+XNB(10,NY,NX)))/VOLW(10,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(11,NY,NX)+XNB(11,NY,NX)))/BKVL(11,NY,NX)
      ELSEIF(VOLW(11,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(11,NY,NX)+ZNH4B(11,NY,NX)
     2+14.0*(XN4(11,NY,NX)+XNB(11,NY,NX)))/VOLW(11,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(12,NY,NX)+XNB(12,NY,NX)))/BKVL(12,NY,NX)
      ELSEIF(VOLW(12,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(12,NY,NX)+ZNH4B(12,NY,NX)
     2+14.0*(XN4(12,NY,NX)+XNB(12,NY,NX)))/VOLW(12,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(13,NY,NX)+XNB(13,NY,NX)))/BKVL(13,NY,NX)
      ELSEIF(VOLW(13,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(13,NY,NX)+ZNH4B(13,NY,NX)
     2+14.0*(XN4(13,NY,NX)+XNB(13,NY,NX)))/VOLW(13,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(14,NY,NX)+XNB(14,NY,NX)))/BKVL(14,NY,NX)
      ELSEIF(VOLW(14,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(14,NY,NX)+ZNH4B(14,NY,NX)
     2+14.0*(XN4(14,NY,NX)+XNB(14,NY,NX)))/VOLW(14,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+14.0*(XN4(15,NY,NX)+XNB(15,NY,NX)))/BKVL(15,NY,NX)
      ELSEIF(VOLW(15,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNH4S(15,NY,NX)+ZNH4B(15,NY,NX)
     2+14.0*(XN4(15,NY,NX)+XNB(15,NY,NX)))/VOLW(15,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(1,NY,NX)+ZNO2B(1,NY,NX))/BKVL(1,NY,NX)
      ELSEIF(VOLW(1,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(1,NY,NX)+ZNO3B(1,NY,NX)
     2+ZNO2S(1,NY,NX)+ZNO2B(1,NY,NX))/VOLW(1,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(2,NY,NX)+ZNO2B(2,NY,NX))/BKVL(2,NY,NX)
      ELSEIF(VOLW(2,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(2,NY,NX)+ZNO3B(2,NY,NX)
     2+ZNO2S(2,NY,NX)+ZNO2B(2,NY,NX))/VOLW(2,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     3+ZNO2S(3,NY,NX)+ZNO2B(3,NY,NX))/BKVL(3,NY,NX)
      ELSEIF(VOLW(3,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(3,NY,NX)+ZNO3B(3,NY,NX)
     2+ZNO2S(3,NY,NX)+ZNO2B(3,NY,NX))/VOLW(3,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(4,NY,NX)+ZNO2B(4,NY,NX))/BKVL(4,NY,NX)
      ELSEIF(VOLW(4,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(4,NY,NX)+ZNO3B(4,NY,NX)
     2+ZNO2S(4,NY,NX)+ZNO2B(4,NY,NX))/VOLW(4,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(5,NY,NX)+ZNO2B(5,NY,NX))/BKVL(5,NY,NX)
      ELSEIF(VOLW(5,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(5,NY,NX)+ZNO3B(5,NY,NX)
     2+ZNO2S(5,NY,NX)+ZNO2B(5,NY,NX))/VOLW(5,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(6,NY,NX)+ZNO2B(6,NY,NX))/BKVL(6,NY,NX)
      ELSEIF(VOLW(6,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(6,NY,NX)+ZNO3B(6,NY,NX)
     2+ZNO2S(6,NY,NX)+ZNO2B(6,NY,NX))/VOLW(6,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(7,NY,NX)+ZNO2B(7,NY,NX))/BKVL(7,NY,NX)
      ELSEIF(VOLW(7,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(7,NY,NX)+ZNO3B(7,NY,NX)
     2+ZNO2S(7,NY,NX)+ZNO2B(7,NY,NX))/VOLW(7,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(8,NY,NX)+ZNO2B(8,NY,NX))/BKVL(8,NY,NX)
      ELSEIF(VOLW(8,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(8,NY,NX)+ZNO3B(8,NY,NX)
     2+ZNO2S(8,NY,NX)+ZNO2B(8,NY,NX))/VOLW(8,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(9,NY,NX)+ZNO2B(9,NY,NX))/BKVL(9,NY,NX)
      ELSEIF(VOLW(9,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(9,NY,NX)+ZNO3B(9,NY,NX)
     2+ZNO2S(9,NY,NX)+ZNO2B(9,NY,NX))/VOLW(9,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(10,NY,NX)+ZNO2B(10,NY,NX))/BKVL(10,NY,NX)
      ELSEIF(VOLW(10,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(10,NY,NX)+ZNO3B(10,NY,NX)
     2+ZNO2S(10,NY,NX)+ZNO2B(10,NY,NX))/VOLW(10,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(11,NY,NX)+ZNO2B(11,NY,NX))/BKVL(11,NY,NX)
      ELSEIF(VOLW(11,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(11,NY,NX)+ZNO3B(11,NY,NX)
     2+ZNO2S(11,NY,NX)+ZNO2B(11,NY,NX))/VOLW(11,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(12,NY,NX)+ZNO2B(12,NY,NX))/BKVL(12,NY,NX)
      ELSEIF(VOLW(12,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(12,NY,NX)+ZNO3B(12,NY,NX)
     2+ZNO2S(12,NY,NX)+ZNO2B(12,NY,NX))/VOLW(12,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(13,NY,NX)+ZNO2B(13,NY,NX))/BKVL(13,NY,NX)
      ELSEIF(VOLW(13,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(13,NY,NX)+ZNO3B(13,NY,NX)
     2+ZNO2S(13,NY,NX)+ZNO2B(13,NY,NX))/VOLW(1,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(14,NY,NX)+ZNO2B(14,NY,NX))/BKVL(14,NY,NX)
      ELSEIF(VOLW(14,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(14,NY,NX)+ZNO3B(14,NY,NX)
     2+ZNO2S(14,NY,NX)+ZNO2B(14,NY,NX))/VOLW(14,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+ZNO2S(15,NY,NX)+ZNO2B(15,NY,NX))/BKVL(15,NY,NX)
      ELSEIF(VOLW(15,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(ZNO3S(15,NY,NX)+ZNO3B(15,NY,NX)
     2+ZNO2S(15,NY,NX)+ZNO2B(15,NY,NX))/VOLW(15,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
...
C
      ...
      IF(K.EQ.5)HEAD(M)=UPX4(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      ...
      IF(K.EQ.12)HEAD(M)=(VPOXG(NY,NX)+VPOXR(NY,NX))
     2/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.13)THEN
      IF(BKVL(1,NY,NX).GT.ZEROS(NY,NX))THEN 
     ...
     2+XH1PB(1,NY,NX)+XH2PB(1,NY,NX))/BKVL(1,NY,NX)
      ELSEIF(VOLW(1,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(1,NY,NX)+XH2P(1,NY,NX)
     2+XH1PB(1,NY,NX)+XH2PB(1,NY,NX))/VOLW(1,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(2,NY,NX)+XH2PB(2,NY,NX))/BKVL(2,NY,NX)
      ELSEIF(VOLW(2,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(2,NY,NX)+XH2P(2,NY,NX)
     2+XH1PB(2,NY,NX)+XH2PB(2,NY,NX))/VOLW(2,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(3,NY,NX)+XH2PB(3,NY,NX))/BKVL(3,NY,NX)
      ELSEIF(VOLW(3,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(3,NY,NX)+XH2P(3,NY,NX)
     2+XH1PB(3,NY,NX)+XH2PB(3,NY,NX))/VOLW(3,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(4,NY,NX)+XH2PB(4,NY,NX))/BKVL(4,NY,NX)
      ELSEIF(VOLW(4,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(4,NY,NX)+XH2P(4,NY,NX)
     2+XH1PB(4,NY,NX)+XH2PB(4,NY,NX))/VOLW(4,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(5,NY,NX)+XH2PB(5,NY,NX))/BKVL(5,NY,NX)
      ELSEIF(VOLW(5,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(5,NY,NX)+XH2P(5,NY,NX)
     2+XH1PB(5,NY,NX)+XH2PB(5,NY,NX))/VOLW(5,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(6,NY,NX)+XH2PB(6,NY,NX))/BKVL(6,NY,NX)
      ELSEIF(VOLW(6,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(6,NY,NX)+XH2P(6,NY,NX)
     2+XH1PB(6,NY,NX)+XH2PB(6,NY,NX))/VOLW(6,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(7,NY,NX)+XH2PB(7,NY,NX))/BKVL(7,NY,NX)
      ELSEIF(VOLW(7,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(7,NY,NX)+XH2P(7,NY,NX)
     2+XH1PB(7,NY,NX)+XH2PB(7,NY,NX))/VOLW(7,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(8,NY,NX)+XH2PB(8,NY,NX))/BKVL(8,NY,NX)
      ELSEIF(VOLW(8,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(8,NY,NX)+XH2P(8,NY,NX)
     2+XH1PB(8,NY,NX)+XH2PB(8,NY,NX))/VOLW(8,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(9,NY,NX)+XH2PB(9,NY,NX))/BKVL(9,NY,NX)
      ELSEIF(VOLW(9,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(9,NY,NX)+XH2P(9,NY,NX)
     2+XH1PB(9,NY,NX)+XH2PB(9,NY,NX))/VOLW(9,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(10,NY,NX)+XH2PB(10,NY,NX))/BKVL(10,NY,NX)
      ELSEIF(VOLW(10,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(10,NY,NX)+XH2P(10,NY,NX)
     2+XH1PB(10,NY,NX)+XH2PB(10,NY,NX))/VOLW(10,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(11,NY,NX)+XH2PB(11,NY,NX))/BKVL(11,NY,NX)
      ELSEIF(VOLW(11,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(11,NY,NX)+XH2P(11,NY,NX)
     2+XH1PB(11,NY,NX)+XH2PB(11,NY,NX))/VOLW(11,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(12,NY,NX)+XH2PB(12,NY,NX))/BKVL(12,NY,NX)
      ELSEIF(VOLW(12,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(12,NY,NX)+XH2P(12,NY,NX)
     2+XH1PB(12,NY,NX)+XH2PB(12,NY,NX))/VOLW(12,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(13,NY,NX)+XH2PB(13,NY,NX))/BKVL(13,NY,NX)
      ELSEIF(VOLW(13,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(13,NY,NX)+XH2P(13,NY,NX)
     2+XH1PB(13,NY,NX)+XH2PB(13,NY,NX))/VOLW(13,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(14,NY,NX)+XH2PB(14,NY,NX))/BKVL(14,NY,NX)
      ELSEIF(VOLW(14,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(14,NY,NX)+XH2P(14,NY,NX)
     2+XH1PB(14,NY,NX)+XH2PB(14,NY,NX))/VOLW(14,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
     ...
     2+XH1PB(15,NY,NX)+XH2PB(15,NY,NX))/BKVL(15,NY,NX)
      ELSEIF(VOLW(15,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=31.0*(XH1P(1,NY,NX)+XH2P(1,NY,NX)
     2+XH1PB(15,NY,NX)+XH2PB(15,NY,NX))/VOLW(15,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      ...
      ENDIF
      ENDIF
      IF(K.EQ.45)HEAD(M)=VPOXFS(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.46)HEAD(M)=UPO4(NY,NX)/AREA(3,NU(NY,NX),NY,NX)
