...
8995  CONTINUE
      ELSE
C      write(*,*)'READ PLANT SPECIES NAMES'
C
C     READ PLANT SPECIES NAMES FROM EARLIER RUN IF NEEDED
C
      REWIND(30)
8000  CONTINUE
      DO 9995 NX=NHW,NHE
...
C
C     MATCH PREVIOUS AND CURRENT PLANT SPECIES
C
      DO 7975 NX=NHW,NHE
      DO 7970 NY=NVN,NVS
      DO 7965 NZ=1,NS
