...
9976  CONTINUE
     ...
     8,TKQC(NZ,NY,NX),VPQC(NZ,NY,NX),CF(NZ,NY,NX),ARSTG(NZ,NY,NX)
      ...
      WRITE(26,92)I,IDATA(3),NZ,(FLGQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
...
9955  WRITE(26,95)I,IDATA(3),NZ,(IDAY(N,NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
     ...
     8,HEAT(NZ,NY,NX),WTRTS(NZ,NY,NX),FRADP(NZ,NY,NX) 
      ...
      IF(ISALTG.NE.0)THEN
      WRITE(27,92)I,IDATA(3),NZ,(ZALQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      WRITE(27,92)I,IDATA(3),NZ,(ZFEQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      WRITE(27,92)I,IDATA(3),NZ,(ZCAQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      WRITE(27,92)I,IDATA(3),NZ,(ZMGQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      WRITE(27,92)I,IDATA(3),NZ,(ZNAQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      WRITE(27,92)I,IDATA(3),NZ,(ZKAQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      WRITE(27,92)I,IDATA(3),NZ,(ZSOQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      WRITE(27,92)I,IDATA(3),NZ,(ZCLQ(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
      ENDIF
...
9970  CONTINUE
      ...
      WRITE(29,94)I,IDATA(3),NZ,(ZALR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(ZFER(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(ZCAR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(ZMGR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(ZNAR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(ZKAR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(ZSOR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(ZCLR(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
9960  CONTINUE
      ENDIF
      ENDIF
9980  CONTINUE
