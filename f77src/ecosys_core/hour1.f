...
C
      ...
      DO 9480 NO=1,7
      DO 9480 NGL=1,JG
      OMCER(3,NGL,NO,K,N,NN,NY,NX)=0.0
      DO 9480 M=1,2
      OMCER(M,NGL,NO,K,N,NN,NY,NX)=0.0
      OMNER(M,NGL,NO,K,N,NN,NY,NX)=0.0
      OMPER(M,NGL,NO,K,N,NN,NY,NX)=0.0
9480  CONTINUE
      DO 9475 K=0,4
      DO 9470 M=1,2
...
C
      ...
      OMC(M,NGL,N,K,LFDPTH,NY,NX)=OMC(M,NGL,N,K,LFDPTH,NY,NX)
     2+OMC1
      OMN(M,NGL,N,K,LFDPTH,NY,NX)=OMN(M,NGL,N,K,LFDPTH,NY,NX)
     2+OMN1
      OMP(M,NGL,N,K,LFDPTH,NY,NX)=OMP(M,NGL,N,K,LFDPTH,NY,NX)
     2+OMP1
C     WRITE(*,2345)'OMCI',I,J,LFDPTH,K,N,M
C    2,OMC1,OMN1,OMP1,OSCI,OMCI(M,K)
C    2,OMCF(N),OSCX,CNOMC(M,NGL,N,K),CPOMC(M,NGL,N,K),OSNI,OSPI
C    2,OMC(M,NGL,N,K,LFDPTH,NY,NX),OMN(M,NGL,N,K,LFDPTH,NY,NX)
2345  FORMAT(A8,6I4,20E12.4)
      OSCX=OSCX+OMC1
      OSNX=OSNX+OMN1
      OSPX=OSPX+OMP1
      DO 2962 NN=1,7
      OMC(M,NGL,NN,5,LFDPTH,NY,NX)=OMC(M,NGL,NN,5,LFDPTH,NY,NX)
     2+OMC1*OMCA(NN)
      OMN(M,NGL,NN,5,LFDPTH,NY,NX)=OMN(M,NGL,NN,5,LFDPTH,NY,NX)
     2+OMN1*OMCA(NN)
      OMP(M,NGL,NN,5,LFDPTH,NY,NX)=OMP(M,NGL,NN,5,LFDPTH,NY,NX)
     2+OMP1*OMCA(NN)
C     WRITE(*,2346)'OMCA',I,J,LFDPTH,K,N,NN,M
C    2,OMC1,OMCA(NN),OMC(M,NGL,NGL,NN,5,LFDPTH,NY,NX)
