...
C     WRITE(21,91)I,IDATA(3),(GKCK(L,NY,NX),L=1,NLI(NY,NX))
      ...
      WRITE(21,91)I,IDATA(3),(XOH0B(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XOH1B(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XOH2B(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XH1PB(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XH2PB(L,NY,NX),L=1,NLI(NY,NX))
      ...
      WRITE(21,91)I,IDATA(3),(PALOH(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PFEOH(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PCACO(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PCASO(L,NY,NX),L=0,NLI(NY,NX))
...
9980  CONTINUE
      ...
      WRITE(22,91)I,IDATA(3),(Z2GG(L,NY,NX),L=0,NLI(NY,NX))
