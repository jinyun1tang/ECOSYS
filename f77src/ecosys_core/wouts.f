...
C
     ...
     9,RCHGNB(NY,NX),RCHGEB(NY,NX),RCHGSB(NY,NX),RCHGWB(NY,NX) 
      ...
      WRITE(21,91)I,IDATA(3),(BKDS(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(CORGC(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(POROS(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(FC(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(WP(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(SCNV(L,NY,NX),L=0,NLI(NY,NX))
      ...
      WRITE(21,91)I,IDATA(3),(VOLV(L,NY,NX),L=0,NLI(NY,NX))
...
C     WRITE(21,91)I,IDATA(3),(GKCK(L,NY,NX),L=1,NLI(NY,NX))
      ...
      WRITE(21,91)I,IDATA(3),(RCH4F(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(RCH4L(L,NY,NX),L=0,NLI(NY,NX))
      ...
      WRITE(21,91)I,IDATA(3),(XHY(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XAL(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XFE(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XCA(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XMG(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XNA(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(XKA(L,NY,NX),L=0,NLI(NY,NX))
      ...
      WRITE(21,91)I,IDATA(3),(XHC(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PALPO(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PFEPO(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PCAPD(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PCAPH(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PCAPM(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PALPB(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PFEPB(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PCPDB(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PCPHB(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(PCPMB(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZAL(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZFE(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZHY(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCA(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZMG(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZNA(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZKA(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZOH(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZSO4(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCL(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCO3(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZHCO3(L,NY,NX),L=0,NLI(NY,NX))
      IF(ISALTG.NE.0)THEN
      ...
      WRITE(21,91)I,IDATA(3),(ZALOH1(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZALOH2(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZALOH3(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZALOH4(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZALS(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZFEOH1(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZFEOH2(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZFEOH3(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZFEOH4(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZFES(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCAO(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCAC(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCAH(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCAS(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZMGO(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZMGC(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZMGH(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZMGS(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZNAC(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZNAS(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZKAS(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZHYSI(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(H0PO4(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(H3PO4(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZFE1P(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZFE2P(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCA0P(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCA1P(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZCA2P(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(ZMG1P(L,NY,NX),L=0,NLI(NY,NX))
      ...
      WRITE(21,91)I,IDATA(3),(QALSI(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(QFESI(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(QCASI(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(QMGSI(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(QNASI(L,NY,NX),L=1,NLI(NY,NX))
      WRITE(21,91)I,IDATA(3),(QKASI(L,NY,NX),L=1,NLI(NY,NX))
      ENDIF
      DO 9985 K=0,5
      DO 9985 N=1,7
...
9975  CONTINUE
      ...
      WRITE(22,91)I,IDATA(3),(OQCH(K,L,NY,NX),L=0,NLI(NY,NX))
      WRITE(22,91)I,IDATA(3),(OQNH(K,L,NY,NX),L=0,NLI(NY,NX))
      WRITE(22,91)I,IDATA(3),(OQPH(K,L,NY,NX),L=0,NLI(NY,NX))
      WRITE(22,91)I,IDATA(3),(OQAH(K,L,NY,NX),L=0,NLI(NY,NX))
...
9980  CONTINUE
      ...
      WRITE(22,91)I,IDATA(3),(ZNH4FB(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(22,91)I,IDATA(3),(ZNH3FB(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(22,91)I,IDATA(3),(ZNHUFB(L,NY,NX),L=0,NLI(NY,NX))
      WRITE(22,91)I,IDATA(3),(ZNO3FB(L,NY,NX),L=0,NLI(NY,NX))
