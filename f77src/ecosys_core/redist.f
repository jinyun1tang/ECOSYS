...
9770  CONTINUE
      ...
      VOLI(NUM(NY,NX),NY,NX)=VOLI(NUM(NY,NX),NY,NX)+FLWI+FLWS/DENSI
...
C
     ...
     2+2.496E-06*ORGC(0,NY,NX)
      ...
      if(IYRC<=1981)THEN
      write(118,*)I+J/24.,VOLW(0,NY,NX),FLWR(NY,NX),THAWR(NY,NX)
     2,TQR(NY,NX),PRECA(NY,NX),CVRD(NY,NX)
      ENDIF
...
C     ENDIF
      IF(IYRC==1990)THEN
      WRITE(113,*)I+J/24.,SUM(OQC(0:2,0,NY,NX)),TKS(0,NY,NX)-273.15
     2,ARLFC(NY,NX)/AREA(3,NU(NY,NX),NY,NX),RCO2O(0,NY,NX)
     3,ORGC(0,NY,NX),sum(OMC(1:3,1,0:2,0,NY,NX))
     4,sum(OMC(1:3,3,0:2,0,NY,NX))
      ELSEIF(IYRC==1980)THEN
      WRITE(114,*)I+J/24.,SUM(OQC(0:2,0,NY,NX)),TKS(0,NY,NX)-273.15
     2,ARLFC(NY,NX)/AREA(3,NU(NY,NX),NY,NX),RCO2O(0,NY,NX)
     3,ORGC(0,NY,NX),sum(OMC(1:3,1,0:2,0,NY,NX))
     4,sum(OMC(1:3,3,0:2,0,NY,NX))
      ENDIF
