...
10    FORMAT(A16)
      IGO=0
C
C     LANDSCAPE GRID CELL ADDRESSES FROM NW (NHW,NVN) TO SE (NHE,NVS)
C
...
C
C     BIOME MANAGEMENT FILE
C
      READ(5,10)DATAC(10,NE,NEX)
C
C     OUTPUT DATA EDITORS
C
      DO 115 N=21,30
...
120   CONTINUE
C
C     SNENARIO COMPLETED, START NEXT SCENARIO
C
      GO TO 100
1000  STOP
      END
