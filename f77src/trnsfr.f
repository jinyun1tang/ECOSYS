...
C
      IF(VOLWM(M,0,NY,NX).GT.ZEROS(NY,NX)
     2.AND.VOLT(0,NY,NX).GT.ZEROS(NY,NX))THEN
      THETW1(0,NY,NX)=AMAX1(0.0,VOLWM(M,0,NY,NX)/VOLT(0,NY,NX))
...
C     IF(J.EQ.24)THEN
C     WRITE(*,1118)'RCODFS',I,J,NX,NY,M,MM,RCODFS(NY,NX)
