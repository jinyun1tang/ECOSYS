...
C
     ...
     4,VOLN3T(JY,JX),VOLNBT(JY,JX),VOLHGT(JY,JX)
      PARAMETER(DPN4=5.7E-07,XFRX=0.5,XFRS=0.05)
...
C     WRITE(*,1118)'RCHDFR',I,J,NX,NY,M,MM,RCHDFR(NY,NX)
C    2,CH4GQ,CH4S2(0,NY,NX),PARR(NY,NX),CCH4E(NY,NX)
C    3,VOLWCH(0,NY,NX),DFGSCH,DPTH0 
C     WRITE(*,1118)'ROXDFR',I,J,NX,NY,M,MM,ROXDFR(NY,NX)
C    2,OXYGQ,OXYS2(0,NY,NX),PARR(NY,NX),COXYE(NY,NX)
C    3,VOLWOX(0,NY,NX),DFGSOX,DPTH0 
...
C
     ...
     2*SH2GL(NU(NY,NX),NY,NX)
      DPTH1=0.5*VOLWM(M,NU(NY,NX),NY,NX)/AREA(3,NU(NY,NX),NY,NX)
      DFGSCO=CLSGL2(NU(NY,NX),NY,NX)/DPTH1 
      DFGSCH=CQSGL2(NU(NY,NX),NY,NX)/DPTH1 
      DFGSOX=OLSGL2(NU(NY,NX),NY,NX)/DPTH1 
      DFGSNG=ZLSGL2(NU(NY,NX),NY,NX)/DPTH1 
      DFGSN2=ZNSGL2(NU(NY,NX),NY,NX)/DPTH1 
      DFGSN3=ZVSGL2(NU(NY,NX),NY,NX)/DPTH1 
      DFGSHL=HLSGL2(NU(NY,NX),NY,NX)/DPTH1 
...
C     IF(I.EQ.87)THEN
C     WRITE(*,1118)'RCHDFS',I,J,NX,NY,M,MM,RCHDFS(NY,NX)
C    2,CH4GQ,CH4S2(NU(NY,NX),NY,NX),PARG(NY,NX)
C    3,CCH4E(NY,NX),VOLWCH(NU(NY,NX),NY,NX),DFGSCH,DPTH1
C     WRITE(*,1118)'ROXDFS',I,J,NX,NY,M,MM,ROXDFS(NY,NX)
C    2,OXYGQ,OXYS2(NU(NY,NX),NY,NX),PARG(NY,NX)
C    3,COXYE(NY,NX),VOLWOX(NU(NY,NX),NY,NX),DFGSOX,DPTH1
C     ENDIF 
C
C     ACCUMULATE HOURLY FLUXES
C
...
C
     ...
     2,VOLWHM(M,NU(NY,NX),NY,NX))
      ...
      DO 8835 K=0,2
      DFVOC(K)=XNPX*(OQCH2(K,NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-OQC2(K,NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
      DFVON(K)=XNPX*(OQNH2(K,NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-OQN2(K,NU(NY,NX),NY,NX)*VOLWHS)/VOLWT 
      DFVOP(K)=XNPX*(OQPH2(K,NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-OQP2(K,NU(NY,NX),NY,NX)*VOLWHS)/VOLWT 
      DFVOA(K)=XNPX*(OQAH2(K,NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-OQA2(K,NU(NY,NX),NY,NX)*VOLWHS)/VOLWT 
8835  CONTINUE
      DFVCOS=XNPX*(CO2SH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-CO2S2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
      DFVCHS=XNPX*(CH4SH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-CH4S2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT 
      DFVOXS=XNPX*(OXYSH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-OXYS2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT 
      DFVNGS=XNPX*(Z2GSH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-Z2GS2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT 
      DFVN2S=XNPX*(Z2OSH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-Z2OS2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT 
      DFVHGS=XNPX*(H2GSH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-H2GS2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT 
      DFVNH4=XNPX*(ZNH4H2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-ZNH4S2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
     3*VLNH4(NU(NY,NX),NY,NX)
      DFVNH3=XNPX*(ZNH3H2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-ZN3S2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
     3*VLNH4(NU(NY,NX),NY,NX)
      DFVNO3=XNPX*(ZNO3H2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-ZNO3S2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
     3*VLNO3(NU(NY,NX),NY,NX)
      DFVNO2=XNPX*(ZNO2H2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-ZNO2S2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
     3*VLNO3(NU(NY,NX),NY,NX)
      DFVPO4=XNPX*(H2P4H2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-H2PO42(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
     3*VLPO4(NU(NY,NX),NY,NX)
      DFVN4B=XNPX*(ZN4BH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-ZNH4B2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
     3*VLNHB(NU(NY,NX),NY,NX)
      DFVN3B=XNPX*(ZN3BH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-ZNBS2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
     3*VLNHB(NU(NY,NX),NY,NX)
      DFVNOB=XNPX*(ZNOBH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-ZNO3B2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
     3*VLNOB(NU(NY,NX),NY,NX)
      DFVN2B=XNPX*(ZN2BH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-ZNO2B2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
     3*VLNOB(NU(NY,NX),NY,NX)
      DFVPOB=XNPX*(H2PBH2(NU(NY,NX),NY,NX)*VOLWM(M,NU(NY,NX),NY,NX)
     2-H2POB2(NU(NY,NX),NY,NX)*VOLWHS)/VOLWT
...
C
      ...
      VFLW=AMAX1(0.0,AMIN1(XFRX,QRM(M,N,N5,N4)/VOLWM(M,0,N2,N1)))
      ELSE
      VFLW=XFRX 
      ENDIF
      DO 9835 K=0,2
...
C
      ...
      VFLW=AMIN1(0.0,AMAX1(-XFRX,QRM(M,N,N5,N4)/VOLWM(M,0,N5,N4)))
      ELSE
      VFLW=-XFRX 
      ENDIF
      DO 9830 K=0,2
...
C    3,VOLPM(M,0,NY,NX),VOLOXR(NY,NX),ROXDXR
...
C
      ...
      VFLW=-AMAX1(0.0,AMIN1(XFRX,FLQM(3,NU(NY,NX),NY,NX)
     2/VOLPM(M,NU(NY,NX),NY,NX)))
      ELSE
      VFLW=-XFRX 
      ENDIF
...
C
     ...
     3/(DLYR(N,N3,N2,N1)+DLYR(N,N6,N5,N4))*(1.0-FMPR(N6,N5,N4))
      DISPN=DISP(N,N6,N5,N4)*ABS(FLWM(M,N,N6,N5,N4)/AREA(N,N6,N5,N4))
      XDPTHM=XDPTH(N,N6,N5,N4)*(1.0-FMPR(N6,N5,N4))
      DIFOC=(OCSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFON=(ONSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFOP=(OPSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFOA=(OASGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFNH=(ZNSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFNO=(ZOSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFPO=(POSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFCS=(CLSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFCQ=(CQSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFOS=(OLSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFNG=(ZLSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFN2=(ZVSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
      DIFHG=(HLSGL2(N6,N5,N4)*TORTL+DISPN)*XDPTHM
C
C     DIFFUSIVE FLUXES BETWEEN CURRENT AND ADJACENT GRID CELL
C     MICROPORES
C
...
C     IF(M.NE.MX.AND.I.EQ.22.AND.J.EQ.12.AND.N6.EQ.2)THEN
...
C     WRITE(*,443)'DFHCO2',I,J,M,MM,N4,N5,N6,N
C    2,RCOFHS(N,N6,N5,N4),RFHCOS,DFHCOS,DIFCS,CCO2SH1,CCO2SH2
C    3,VFLW,CO2SH2(N6,N5,N4),VOLWHM(M,N6,N5,N4)
C    4,TORTL,DISPN,XDPTH(N,N6,N5,N4),FHOL(N6,N5,N4)
...
C
      ...
      DO 9955 K=0,2
      DFVOC(K)=XNPX*(OQCH2(K,N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-OQC2(K,N6,N5,N4)*VOLWHS)/VOLWT
      DFVON(K)=XNPX*(OQNH2(K,N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-OQN2(K,N6,N5,N4)*VOLWHS)/VOLWT 
      DFVOP(K)=XNPX*(OQPH2(K,N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-OQP2(K,N6,N5,N4)*VOLWHS)/VOLWT 
      DFVOA(K)=XNPX*(OQAH2(K,N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-OQA2(K,N6,N5,N4)*VOLWHS)/VOLWT 
9955  CONTINUE
      DFVCOS=XNPX*(CO2SH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-CO2S2(N6,N5,N4)*VOLWHS)/VOLWT
      DFVCHS=XNPX*(CH4SH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-CH4S2(N6,N5,N4)*VOLWHS)/VOLWT 
      DFVOXS=XNPX*(OXYSH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-OXYS2(N6,N5,N4)*VOLWHS)/VOLWT 
      DFVNGS=XNPX*(Z2GSH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-Z2GS2(N6,N5,N4)*VOLWHS)/VOLWT 
      DFVN2S=XNPX*(Z2OSH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-Z2OS2(N6,N5,N4)*VOLWHS)/VOLWT 
      DFVHGS=XNPX*(H2GSH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-H2GS2(N6,N5,N4)*VOLWHS)/VOLWT 
      DFVNH4=XNPX*(ZNH4H2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-ZNH4S2(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLNH4(N6,N5,N4)
      DFVNH3=XNPX*(ZNH3H2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-ZN3S2(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLNH4(N6,N5,N4)
      DFVNO3=XNPX*(ZNO3H2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-ZNO3S2(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLNO3(N6,N5,N4)
      DFVNO2=XNPX*(ZNO2H2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-ZNO2S2(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLNO3(N6,N5,N4)
      DFVPO4=XNPX*(H2P4H2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-H2PO42(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLPO4(N6,N5,N4)
      DFVN4B=XNPX*(ZN4BH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-ZNH4B2(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLNHB(N6,N5,N4)
      DFVN3B=XNPX*(ZN3BH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-ZNBS2(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLNHB(N6,N5,N4)
      DFVNOB=XNPX*(ZNOBH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-ZNO3B2(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLNOB(N6,N5,N4)
      DFVN2B=XNPX*(ZN2BH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-ZNO2B2(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLNOB(N6,N5,N4)
      DFVPOB=XNPX*(H2PBH2(N6,N5,N4)*VOLWM(M,N6,N5,N4)
     2-H2POB2(N6,N5,N4)*VOLWHS)/VOLWT
     3*VLPOB(N6,N5,N4)
      ELSE
      DO 9975 K=0,2
      DFVOC(K)=0.0
...
C
      ...
      XOCFXS(K,N6,N5,N4)=XOCFXS(K,N6,N5,N4)
     2+ROCFXS(K,N6,N5,N4)
      XONFXS(K,N6,N5,N4)=XONFXS(K,N6,N5,N4)
     2+RONFXS(K,N6,N5,N4)
      XOPFXS(K,N6,N5,N4)=XOPFXS(K,N6,N5,N4)
     2+ROPFXS(K,N6,N5,N4)
      XOAFXS(K,N6,N5,N4)=XOAFXS(K,N6,N5,N4)
     2+ROAFXS(K,N6,N5,N4)
9950  CONTINUE
...
C     IF(I.EQ.22.AND.J.EQ.12.AND.N6.EQ.2)THEN
C     WRITE(*,7777)'RCOFXS',I,J,M,MM,N4,N5,N6
C    2,RCOFXS(N6,N5,N4),RFLCOS,DFVCOS,CO2S2(N6,N5,N4)
C    3,CO2SH2(N6,N5,N4),XCOFXS(N6,N5,N4)
7777  FORMAT(A8,7I4,12E12.4)
C     ENDIF
      ENDIF
      ENDIF
C
...
C
      ...
      VFLW=-AMAX1(0.0,AMIN1(XFRX,FLQM(N,N6,N5,N4)
     2/VOLPM(M,N6,N5,N4)))
      ELSE
      VFLW=-XFRX 
      ENDIF
      ...
      VFLW=-AMIN1(0.0,AMAX1(-XFRX,FLQM(N,N6,N5,N4)
     2/VOLPM(M,N3,N2,N1)))
      ELSE
      VFLW=XFRX 
      ENDIF
...
C
     ...
     2.OR.NN.EQ.2.AND.QRM(M,N,M5,M4).LT.0.0)THEN
      ...
      VFLW=AMAX1(-XFRX,AMIN1(XFRX,QRM(M,N,M5,M4)
     2/VOLWM(M,0,M2,M1)))
      ELSE
      VFLW=0.0
      ENDIF
...
C     ENDIF
C
C     NO SOLUTE GAIN WITH SUBSURFACE MICROPORE WATER GAIN
C
      ELSE
      DO 9515 K=0,4
...
9555  CONTINUE
      ...
      ENDIF
C
C     NO GASOUS GAIN WITH SUBSURFACE MICROPORE WATER LOSS
C
      FLGM=(FLWM(M,N,M6,M5,M4)+FLWHM(M,N,M6,M5,M4))*XNPT
C     IF(NN.EQ.1.AND.FLGM.GT.0.0
C    2.OR.NN.EQ.2.AND.FLGM.LT.0.0)THEN
C     IF(VOLPM(M,M3,M2,M1).GT.ZEROS(M2,M1))THEN
C     VFLW=-AMAX1(-XFRX,AMIN1(XFRX,FLGM
...
C
     ...
     2.OR.NN.EQ.2.AND.FLGM.GT.0.0)THEN
      ...
      VFLW=-AMAX1(-XFRX,AMIN1(XFRX,FLGM
     2/VOLPM(M,M3,M2,M1)))
      ELSE
      VFLW=0.0
      ENDIF
...
C     TOTAL GAS FLUX
C
C     IF(NCN(N2,N1).NE.3.OR.N.EQ.3)THEN
...
C     IF(I.EQ.22.AND.J.EQ.12.AND.L.EQ.2)THEN
...
C    7,CO2SH2(L,NY,NX),TCOFHS(L,NY,NX)
...
C    7,COXYE(NY,NX),FLQM(N,L,NY,NX)
