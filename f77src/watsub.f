...
C
     ...
     2-THETWX(0,NY,NX)))/POROS0(NY,NX))+1))
     ...
     2*AREA(3,NUM(NY,NX),NY,NX)*CVRDC(NY,NX)*XNPH
     ...
     2,-VOLP1(0,NY,NX),VOLP1Z(NUM(NY,NX),NY,NX))*XNPH)
      ...
      FLWRM(M,NY,NX)=FLXSR
C     IF(I.EQ.121)THEN
C     WRITE(*,4322)'FLXSR',I,J,M,NX,NY,NUM(NY,NX),K0,FLXSR,HFLXSR,FLXQR
C    2,PSISM1(0,NY,NX),PSISM1(NUM(NY,NX),NY,NX),CVRDC(NY,NX),CNDR,CND1
C    3,POROS0(NY,NX),THETWX(0,NY,NX)
