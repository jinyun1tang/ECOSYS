...
C
     ...
     9,SHCAH2=SHCAH1/DPH2P**3,SYCAH2=SHCAH2*DPH2O**7)
      PARAMETER (TPD=0.1,TAD=0.1,TSL=0.1,A0=1.0,COOH=2.5E-02)
C
...
C
     ...
     5+GKCN(L,NY,NX)*CNA1/CCAX+GKCK(L,NY,NX)*CKA1/CCAX)
      ...
      ENDIF 
      XN41=XN41+RXN4
C     WRITE(*,2224)'RXN4E',K,L,M,RXN4,CN41,XN4Q,XN41,XCAX,CCEC,FX
C    2,XHYQ,XALQ,XFEQ,XCAQ,XMGQ,XNAQ,XKAQ,CALX,CFEX,CCAX,CMGX,CNA1,CKA1
C    3,CN4X,CNH4(L,NY,NX),XCEC(L,NY,NX)
...
C    2,VOLW(L,NY,NX),VLNH4(L,NY,NX)
