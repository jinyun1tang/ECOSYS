...
C
     ...
     9,SHCAH2=SHCAH1/DPH2P**3,SYCAH2=SHCAH2*DPH2O**7)
      PARAMETER (TPD=0.01,TAD=0.01,TSL=0.01,A0=1.0,COOH=2.5E-02)
C
...
C
      ...
      ENDIF
      IF(CALZ.LT.0.0)THEN
      CAL1=AMIN1(1.0E+03,SPALO/(COH1**3*A3))
      ELSE
      CAL1=AMIN1(CALZ,SPALO/(COH1**3*A3))
      ENDIF
      IF(CFEZ.LT.0.0)THEN
      CFE1=AMIN1(1.0E+03,SPFEO/(COH1**3*A3))
      ELSE
...
C     WRITE(*,1112)'ALOHI',I,L,K,M,PALOH1,AAL1,AALO1,AALO2,AALO3,AALO4
...
C
      ...
      ENDIF
C     IF((M/25)*25.EQ.M)THEN 
C     WRITE(*,1112)'FEOHI',I,L,K,M,PFEOH1,AFE1,AFEO1,AFEO2,AFEO3,AFEO4
...
C     WRITE(*,1112)'CALC',I,J,L,K,M,PCASO1,ACO31,AHCO31,ACO21,CHY1
...
C
      ...
      ENDIF
C     IF((M/25)*25.EQ.M)THEN 
C     WRITE(*,1112)'ALPO4I',I,L,K,M,PALPO1,AAL1,AALO1,AALO2,AALO3,AALO4
...
C
      ...
      ENDIF
C     IF((M/25)*25.EQ.M)THEN 
C     WRITE(*,1112)'FEPO4I',I,L,K,M,PFEPO1,AFE1,AFEO1,AFEO2,AFEO3,AFEO4
...
C
      ...
      ENDIF
C     IF((M/25)*25.EQ.M)THEN 
C     WRITE(*,1112)'APATITEI',I,L,K,M,PCAPH1,ACA1 
...
C
      ...
      VOLWBK=AMIN1(1.0,BKVL(L,NY,NX)/VOLW(L,NY,NX))
      ELSE
      VOLWBK=1.0
      ENDIF
      IF(AEC(L,NY,NX).GT.ZEROS(NY,NX))THEN
...
C
     ...
     5+GKCN(L,NY,NX)*ANA1/ACAX+GKCK(L,NY,NX)*AKA1/ACAX)
      ...
      XNAQ=FX*XNAQ
      XKAQ=FX*XKAQ
      RXN4=TAD*(XN4Q-XN41)*AN41/XN4Q
      RXHY=TAD*(XHYQ-XHY1)*AHY1/XHYQ
      RXAL=TAD*(XALQ-XAL1)*AALX/XALQ
      RXFE=TAD*(XFEQ-XFE1)*AFEX/XFEQ
      RXCA=TAD*(XCAQ-XCA1)*ACAX/XCAQ
      RXMG=TAD*(XMGQ-XMG1)*AMGX/XMGQ
      RXNA=TAD*(XNAQ-XNA1)*ANA1/XNAQ
      RXKA=TAD*(XKAQ-XKA1)*AKA1/XKAQ
      XN41=XN41+RXN4
      XHY1=XHY1+RXHY 
      XAL1=XAL1+RXAL 
      XFE1=XFE1+RXFE 
      ...
      XKA1=XKA1+RXKA
C     IF((M/25)*25.EQ.M)THEN 
C     WRITE(*,1112)'RXFEI',I,L,K,M,CCEC,XCAX,XN41,XHY1,XAL1,XFE1
C    2,XCA1,XMG1,XNA1,XKA1,AAL1,AFE1,ACA1 
C     ENDIF
C
C     ORGANIC MATTER
C
...
C
     ...
     5+GKCN(L,NY,NX)*CNA1/CCAX+GKCK(L,NY,NX)*CKA1/CCAX)
      ...
      ENDIF
      XN4Q=FX*XN4Q
      RXN4=TSL*(XN4Q-XN41)*CN41/XN4Q 
      XN41=XN41+RXN4
C     WRITE(*,2224)'RXN4',NX,NY,L,M,RXN4,CN41,XN4Q,XN41,XCAX,CCEC,FX
C    2,XHYQ,XALQ,XFEQ,XCAQ,XMGQ,XNAQ,XKAQ,CALX,CFEX,CCAX,CMGX,CNA1,CKA1
2224  FORMAT(A8,4I4,40E12.4)
      ELSE
      RPALPX=0.0
      RPFEPX=0.0
      RPCADX=0.0
...
C
      ...
      Z1PW(NY,NX)=VOLWW*CH1PR(NY,NX)*31.0
