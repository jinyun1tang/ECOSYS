...
C     ENDIF
      RA(NZ,NY,NX)=AMAX1(RACM,0.80*RA1,AMIN1(1.20*RA1
...
C
     ...
     2,AMIN1((PSILC-PSIST1(L))/RSRS(N,L),VOLP(L,NY,NX)*FPQ(L,NZ)))
      ...
      UPWTR(N,L,NZ,NY,NX)=0.0
      ENDIF
C     IF(IYRC.EQ.1813.AND.I.GT.200.AND.L.EQ.1)THEN
...
C    3,RSRR(N,NZ,NY,NX),VOLA(L,NY,NX),VOLWM(NPH,L,NY,NX),FPQ(L,NZ)
