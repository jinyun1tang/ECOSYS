...
C
      ...
      IF(K.EQ.13)THEN
      IF(BKVL(1,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(1,NY,NX)+H2POB(1,NY,NX))/VOLW(1,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      IF(K.EQ.14)THEN
      IF(BKVL(2,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(2,NY,NX)+H2POB(2,NY,NX))/VOLW(2,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      IF(K.EQ.15)THEN
      IF(BKVL(3,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(3,NY,NX)+H2POB(3,NY,NX))/VOLW(3,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      IF(K.EQ.16)THEN
      IF(BKVL(4,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(4,NY,NX)+H2POB(4,NY,NX))/VOLW(4,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      IF(K.EQ.17)THEN
      IF(BKVL(5,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(5,NY,NX)+H2POB(5,NY,NX))/VOLW(5,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      IF(K.EQ.18)THEN
      IF(BKVL(6,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(6,NY,NX)+H2POB(6,NY,NX))/VOLW(6,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      IF(K.EQ.19)THEN
      IF(BKVL(7,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(7,NY,NX)+H2POB(7,NY,NX))/VOLW(7,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      IF(K.EQ.20)THEN
      IF(BKVL(8,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(8,NY,NX)+H2POB(8,NY,NX))/VOLW(8,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      IF(K.EQ.21)THEN
      IF(BKVL(9,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(9,NY,NX)+H2POB(9,NY,NX))/VOLW(9,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ENDIF
      IF(K.EQ.22)THEN
      IF(BKVL(10,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(10,NY,NX)+H2POB(10,NY,NX))
     2/VOLW(10,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ...
      IF(K.EQ.23)THEN
      IF(BKVL(11,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(11,NY,NX)+H2POB(11,NY,NX))
     2/VOLW(11,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ...
      IF(K.EQ.24)THEN
      IF(BKVL(12,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(12,NY,NX)+H2POB(12,NY,NX))
     2/VOLW(12,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ...
      IF(K.EQ.25)THEN
      IF(BKVL(13,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(13,NY,NX)+H2POB(13,NY,NX))
     2/VOLW(13,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ...
      IF(K.EQ.26)THEN
      IF(BKVL(14,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(14,NY,NX)+H2POB(14,NY,NX))
     2/VOLW(14,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
      ...
      IF(K.EQ.27)THEN
      IF(BKVL(15,NY,NX).GT.ZEROS(NY,NX))THEN 
      HEAD(M)=(H2PO4(15,NY,NX)+H2POB(15,NY,NX))
     2/VOLW(15,NY,NX)
      ELSE
      HEAD(M)=0.0
      ENDIF
