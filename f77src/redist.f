...
C     H1PO4(NW(NY,NX),NY,NX)=H1PO4(NW(NY,NX),NY,NX)+H1PO4(0,NY,NX)
...
C     TLN2G=TLN2G-ZG
C     ZSH=ZNH4S(0,NY,NX)+ZNH3S(0,NY,NX)
C     ZX=14.0*XN4(0,NY,NX) 
C     TLNH4=TLNH4-ZS-ZX
C     UNH4(NY,NX)=UNH4(NY,NX)-ZS-ZX
C     ZNO=ZNO3S(0,NY,NX)+ZNO2S(0,NY,NX)
C     TLNO3=TLNO3-ZNO
C     UNO3(NY,NX)=UNO3(NY,NX)-ZNO
C     PS=H1PO4(0,NY,NX)+H2PO4(0,NY,NX)
C     PX=31.0*(XH1P(0,NY,NX)+XH2P(0,NY,NX))
C     TLPO4=TLPO4-P4
C     UPO4(NY,NX)=UPO4(NY,NX)-PX
C     CO2S(0,NY,NX)=0.0
C     CH4S(0,NY,NX)=0.0
C     OXYS(0,NY,NX)=0.0
C     Z2GS(0,NY,NX)=0.0
...
C    3,VOLI(0,NY,NX),FLWR(NY,NX),THAWR(NY,NX) 
...
C     ENDIF
C     IF(NX.EQ.5)THEN
C     WRITE(20,5533)'NH30',I,J,NX,NY,ZNH4S(0,NY,NX),XN4FLW(3,0,NY,NX)
...
C     TOTAL DOC, DON, DOP
C
      RC=RC+OQC(K,0,NY,NX)+OQCH(K,0,NY,NX)+OHC(K,0,NY,NX) 
...
C    3,FLU(L,NY,NX),TQR(NY,NX),VOLI(L,NY,NX),TTHAW(L,NY,NX),DENSI 
...
C
     ...
     3+12.0*TRCO2(L,NY,NX)+XCOBBL(L,NY,NX)
...
C
     ...
     2-XN3BBL(L,NY,NX)-XNBBBL(L,NY,NX)
      ...
      COB=TCO2P(L,NY,NX)+TCO2S(L,NY,NX)-12.0*TRCO2(L,NY,NX)
      TCOU=TCOU+COB
      ...
      UDICD(NY,NX)=UDICD(NY,NX)-12.0*TRCO2(L,NY,NX)
      TNBP(NY,NX)=TNBP(NY,NX)+CH+12.0*TRCO2(L,NY,NX)
      OXYGIN=OXYGIN+OIB
...
C    4,TOXFLA(L,NY,NX),OXYG(L,NY,NX)
...
C
     ...
     3-TUPH2P(L,NY,NX)-TUPH2B(L,NY,NX)))/31.0
      SSB=TRH2O(L,NY,NX)+TRCO2(L,NY,NX)+XZHYS(L,NY,NX)
     2+TBION(L,NY,NX)
      TIONOU=TIONOU-SSB
C     UIONOU(NY,NX)=UIONOU(NY,NX)-SSB
C     WRITE(20,3339)'SSB',I,J,L,SSB,TRH2O(L,NY,NX)
C    2,TRCO2(L,NY,NX),XZHYS(L,NY,NX),TBION(L,NY,NX)
C
...
C     WRITE(20,5545)'ZOH',I,J,NX,NY,L
...
2222  FORMAT(A8,5I6,240F17.10)
2223  FORMAT(A8,6I6,160F16.9)
2224  FORMAT(A8,5I6,160F16.9)
C     ENDIF
9990  CONTINUE
9995  CONTINUE
      RETURN
