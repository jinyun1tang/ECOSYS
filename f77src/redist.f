...
6900  CONTINUE
      ...
      UNH4(NY,NX)=UNH4(NY,NX)+Z4S+Z4X+Z4F
...
C     ENDIF
     ...
     3+XN4FXW(L,NY,NX) 
C     IF(L.EQ.1)THEN
C     WRITE(20,4443)'H2GS',I,J,NX,NY,L,H2GS(L,NY,NX),THGFLS(L,NY,NX)
C    2,XHGDFG(L,NY,NX),RH2GO(L,NY,NX),TUPHGS(L,NY,NX),RHGFLU(L,NY,NX)
C    3,XHGFXS(L,NY,NX),XHGBBL(L,NY,NX),XHGDFS(NY,NX)
C     WRITE(20,4444)'NH3',I,J,NX,NY,L,ZNH3S(L,NY,NX),TN3FLS(L,NY,NX)
