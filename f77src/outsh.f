...
C
      ...
      IF(K.EQ.19)HEAD(M)=CCO2S(15,NY,NX)
...
C
      ...
      IF(CHOICE(K,N-20).EQ.'YES')THEN
      M=M+1
      IF(K.EQ.1)HEAD(M)=(FLW(3,NU(NY,NX),NY,NX)
     2+FLWH(3,NU(NY,NX),NY,NX))*1000.0/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.2)HEAD(M)=(QR(1,NY,NX+1)+QR(2,NY+1,NX))
     2*1000.0/TAREA
      IF(K.EQ.3)HEAD(M)=(XSEDER(1,NY,NX+1)+XSEDER(2,NY+1,NX))
     2*1000.0/TAREA
      IF(K.EQ.4)HEAD(M)=UVOLW(NY,NX) 
     2*1000.0/AREA(3,NU(NY,NX),NY,NX)
      IF(K.EQ.5)HEAD(M)=HVOLO(NY,NX)
     2*1000.0/TAREA
      IF(K.EQ.6)HEAD(M)=AMAX1(1.0E-64,(VOLSS(NY,NX)+VOLIS(NY,NX)
     2+VOLWS(NY,NX))*1000.0/AREA(3,NU(NY,NX),NY,NX))
     ...
     2,VOLWH(12,NY,NX)))/VOLT(12,NY,NX)
      IF(K.EQ.19)HEAD(M)=(VOLW(13,NY,NX)+AMIN1(VOLAH(13,NY,NX)
     2,VOLWH(13,NY,NX)))/VOLT(13,NY,NX)
      IF(K.EQ.20)HEAD(M)=(VOLW(14,NY,NX)+AMIN1(VOLAH(14,NY,NX)
     2,VOLWH(14,NY,NX)))/VOLT(14,NY,NX)
      IF(K.EQ.21)HEAD(M)=(VOLW(15,NY,NX)+AMIN1(VOLAH(15,NY,NX)
     2,VOLWH(15,NY,NX)))/VOLT(15,NY,NX)
      IF(K.EQ.22)HEAD(M)=(VOLW(16,NY,NX)+AMIN1(VOLAH(16,NY,NX)
     2,VOLWH(16,NY,NX)))/VOLT(16,NY,NX)
      IF(K.EQ.23)HEAD(M)=(VOLW(17,NY,NX)+AMIN1(VOLAH(17,NY,NX)
     2,VOLWH(17,NY,NX)))/VOLT(17,NY,NX)
      IF(K.EQ.24)HEAD(M)=(VOLW(18,NY,NX)+AMIN1(VOLAH(18,NY,NX)
     2,VOLWH(18,NY,NX)))/VOLT(18,NY,NX)
      IF(K.EQ.25)HEAD(M)=(VOLW(19,NY,NX)+AMIN1(VOLAH(19,NY,NX)
     2,VOLWH(19,NY,NX)))/VOLT(19,NY,NX)
      IF(K.EQ.26)HEAD(M)=(VOLW(20,NY,NX)+AMIN1(VOLAH(20,NY,NX)
     2,VOLWH(20,NY,NX)))/VOLT(20,NY,NX)
      IF(K.EQ.27)THEN
      HEAD(M)=1000.0*AMAX1(0.0,VOLW(0,NY,NX)-VOLWRX(NY,NX))
     2/AREA(3,NU(NY,NX),NY,NX)
      ENDIF
      IF(K.EQ.28)HEAD(M)=(VOLI(1,NY,NX)+AMIN1(VOLAH(1,NY,NX)
     2,VOLIH(1,NY,NX)))/VOLT(1,NY,NX)
      IF(K.EQ.29)HEAD(M)=(VOLI(2,NY,NX)+AMIN1(VOLAH(2,NY,NX)
     2,VOLIH(2,NY,NX)))/VOLT(2,NY,NX)
      IF(K.EQ.30)HEAD(M)=(VOLI(3,NY,NX)+AMIN1(VOLAH(3,NY,NX)
     2,VOLIH(3,NY,NX)))/VOLT(3,NY,NX)
      IF(K.EQ.31)HEAD(M)=(VOLI(4,NY,NX)+AMIN1(VOLAH(4,NY,NX)
     2,VOLIH(4,NY,NX)))/VOLT(4,NY,NX)
      IF(K.EQ.32)HEAD(M)=(VOLI(5,NY,NX)+AMIN1(VOLAH(5,NY,NX)
     2,VOLIH(5,NY,NX)))/VOLT(5,NY,NX)
      IF(K.EQ.33)HEAD(M)=(VOLI(6,NY,NX)+AMIN1(VOLAH(6,NY,NX)
     2,VOLIH(6,NY,NX)))/VOLT(6,NY,NX)
      IF(K.EQ.34)HEAD(M)=(VOLI(7,NY,NX)+AMIN1(VOLAH(7,NY,NX)
     2,VOLIH(7,NY,NX)))/VOLT(7,NY,NX)
      IF(K.EQ.35)HEAD(M)=(VOLI(8,NY,NX)+AMIN1(VOLAH(8,NY,NX)
     2,VOLIH(8,NY,NX)))/VOLT(8,NY,NX)
      IF(K.EQ.36)HEAD(M)=(VOLI(9,NY,NX)+AMIN1(VOLAH(9,NY,NX)
     2,VOLIH(9,NY,NX)))/VOLT(9,NY,NX)
      IF(K.EQ.37)HEAD(M)=(VOLI(10,NY,NX)+AMIN1(VOLAH(10,NY,NX)
     2,VOLIH(10,NY,NX)))/VOLT(10,NY,NX)
      IF(K.EQ.38)HEAD(M)=(VOLI(11,NY,NX)+AMIN1(VOLAH(11,NY,NX)
     2,VOLIH(11,NY,NX)))/VOLT(11,NY,NX)
      IF(K.EQ.39)HEAD(M)=(VOLI(12,NY,NX)+AMIN1(VOLAH(12,NY,NX)
     2,VOLIH(12,NY,NX)))/VOLT(12,NY,NX)
      IF(K.EQ.40)HEAD(M)=(VOLI(13,NY,NX)+AMIN1(VOLAH(13,NY,NX)
     2,VOLIH(13,NY,NX)))/VOLT(13,NY,NX)
      IF(K.EQ.41)HEAD(M)=(VOLI(14,NY,NX)+AMIN1(VOLAH(14,NY,NX)
     2,VOLIH(14,NY,NX)))/VOLT(14,NY,NX)
      IF(K.EQ.42)HEAD(M)=(VOLI(15,NY,NX)+AMIN1(VOLAH(15,NY,NX)
     2,VOLIH(15,NY,NX)))/VOLT(15,NY,NX)
      IF(K.EQ.43)HEAD(M)=(VOLI(16,NY,NX)+AMIN1(VOLAH(16,NY,NX)
     2,VOLIH(16,NY,NX)))/VOLT(16,NY,NX)
      IF(K.EQ.44)HEAD(M)=(VOLI(17,NY,NX)+AMIN1(VOLAH(17,NY,NX)
     2,VOLIH(17,NY,NX)))/VOLT(17,NY,NX)
      IF(K.EQ.45)HEAD(M)=(VOLI(18,NY,NX)+AMIN1(VOLAH(18,NY,NX)
     2,VOLIH(18,NY,NX)))/VOLT(18,NY,NX)
      IF(K.EQ.46)HEAD(M)=(VOLI(19,NY,NX)+AMIN1(VOLAH(19,NY,NX)
     2,VOLIH(19,NY,NX)))/VOLT(19,NY,NX)
      IF(K.EQ.47)HEAD(M)=(VOLI(20,NY,NX)+AMIN1(VOLAH(20,NY,NX)
     2,VOLIH(20,NY,NX)))/VOLT(20,NY,NX)
      IF(K.EQ.48)THEN
