...
C
      RXN4=TADCX*AMIN1((XN4Q-XN41)*AN41/XN4Q,CN41) 
      RXNB=TADCX*AMIN1((XNBQ-XN4B)*AN4B/XNBQ,CN4B)
C
...
C     NH4 EXCHANGE IN NON-BAND AND BAND SOIL ZONES
C
      RXN4=TADC*AMIN1((XN4Q-XN41)*CN41/XN4Q,CN41) 
      RXNB=TADC*AMIN1((XNBQ-XN4B)*CN4B/XNBQ,CN4B)
      ELSE
      RXN4=0.0
      RXNB=0.0
      ENDIF
...
C     IF(IYRC.EQ.2012.AND.I.EQ.151.AND.NX.EQ.1)THEN
C     WRITE(*,24)'RN4S',I,J,L,RN4S,RN3S,RNH4,RXN4
