...
C
     ...
     3,OUTS(10),OUTP(10),OUTFILS(10,JY,JX),OUTFILP(10,JP,JY,JX)
      ...
      DATA IFLGY,IYRX,IYRY,IYRD/0,0,0,0/
      SAVE N1,N2,N1X,N2X,IFLGY,IYRX,IYRY,IYRD
C
...
26    CONTINUE
      ...
      NTZX=NTZ
      IF(IGO.NE.0.AND.IDATA(3).EQ.0)THEN
...
C    2,NE,NT,NEX,NF,NTX,NFX,NTZ,NTZX,N1,N2,N1X,N2X,NA(NEX),ND(NEX),NAX
7766  FORMAT(A8,30I8)
C
...
C
      ...
      IFLGY=1
      IYRY=IDAT(K)
      IYRY=IYRY+(NT-1)*NF+(NTX-1)*NFX-NTZX
      IF(MOD(IDAT(K),4))170,175,170
175   IYRD=366
170   IYRD=365
      ENDIF
160   CONTINUE
      IF(IFLGY.EQ.1.AND.IYRY.LE.IYRX)GO TO 60
      IF(CTYPE.EQ.'J')THEN
      I=N
      ELSE
      LPY=0
...
C
      ...
      READ(2,*,END=105)DST,DEN,FIRRX,CIRRX,DIRRX,WDPTHI,PHQX,CN4QX,CNOQX
     2,CPOQX,CALQX,CFEQX,CCAQX,CMGQX,CNAQX,CKAQX,CSOQX,CCLQX
      LPY=0
