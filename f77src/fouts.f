...
4030  CONTINUE
      CLOSE(15)
      LUN=N+10
      OPEN(LUN,FILE=OUTS(N-20),STATUS='UNKNOWN')
C
...
1025  CONTINUE
      ...
      IF(L.EQ.11)HEAD(M)='SURF_DOC_FLUX'
      IF(L.EQ.12)HEAD(M)='SUBS_DOC_FLUX'
      IF(L.EQ.13)HEAD(M)='SURF_DIC_FLUX'
      IF(L.EQ.14)HEAD(M)='SUBS_DIC_FLUX'
...
1027  CONTINUE
      ...
      IF(L.EQ.7)HEAD(M)='SURF_DON_FLUX'
      IF(L.EQ.8)HEAD(M)='SUBS_DON_FLUX'
      IF(L.EQ.9)HEAD(M)='SURF_DIN_FLUX'
      IF(L.EQ.10)HEAD(M)='SUBS_DIN_FLUX'
...
1028  CONTINUE
      ...
      IF(L.EQ.6)HEAD(M)='SURF_DOP_FLUX'
      IF(L.EQ.7)HEAD(M)='SUBS_DOP_FLUX'
      IF(L.EQ.8)HEAD(M)='SURF_DIP_FLUX'
      IF(L.EQ.9)HEAD(M)='SUBS_DIP_FLUX'
