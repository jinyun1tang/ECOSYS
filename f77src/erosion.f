...
C
      ...
      DIMENSION SED2(JY,JX),RERSED(2,JV,JH),TERSED(JY,JX)
     2,RDTSED(JY,JX)
      DO 9995 NX=NHW,NHE
      DO 9990 NY=NVN,NVS
...
C
     ...
     2.AND.VOLGM(M,N2,N1).GT.ZEROS(N2,N1)
     3.AND.BKDS(NU(N2,N1),N2,N1).GT.ZERO)THEN
...
C
      ...
      CSEDE=0.0
      ENDIF
      RERSED(N,N5,N4)=AMIN1(SED2(N2,N1),CSEDE*QRM(M,N,N5,N4))
      ...
      CSEDE=0.0
      ENDIF
      RERSED(N,N5,N4)=AMAX1(-SED2(N5,N4),CSEDE*QRM(M,N,N5,N4))
      ENDIF
      XSEDER(N,N5,N4)=XSEDER(N,N5,N4)+RERSED(N,N5,N4)
C     WRITE(*,1113)'INTL',I,J,M,N1,N2,N4,N5,N,RERSED(N,N5,N4)
C    2,XSEDER(N,N5,N4),SED2(N2,N1),SED2(N5,N4),CSEDE
...
C
     ...
     2.OR.NN.EQ.2.AND.QRM(M,N,M5,M4).LT.0.0)THEN
      ...
      CSEDE=AMAX1(0.0,SED2(M2,M1)/VOLGM(M,M2,M1))
      ELSE
      CSEDE=0.0
      ENDIF
...
C    2,RERSED(N,M5,M4)
C    2,XSEDER(N,M5,M4),SED2(M2,M1),SED2(M5,M4),CSEDE
C    3,QRM(M,N,M5,M4),QRV(M,N,M5,M4),VOLGM(M,M2,M1)
C    4,VOLGM(M,M5,M4),BKDS(NU(M2,M1),M2,M1)
