...
C
     ...
     2,NBZ(10),FXFB(0:3),FXRT(0:1),FXSH(0:1) 
     3,VMXS(0:1,0:5),WTLSBZ(10),CPOOLZ(10),ZPOOLZ(10),PPOOLZ(10)
     4,ZCX(JP,JY,JX),UPNFC(JP,JY,JX),FRSV(0:3),FXFV(0:1),FXFZ(0:1)
     5,FXRN(4) 
...
C     DIMENSION VCO2(400,366,05)
     ...
     2,CCNKX=1.0E+02,WTNDI=0.01)
      DATA RCCZ/0.167,0.167,0.067,0.167/
      DATA RCCY/0.333,0.333,0.133,0.333/
      DATA RCCX/0.250,0.750,0.750/
      DATA RCCQ/0.833,0.833,0.833/
      DATA FXRN/0.50,0.025,0.25,0.025/
      DATA FXFB/5.0E-03,5.0E-03,5.0E-06,5.0E-06/
...
C     ENDIF
     ...
     2-WTRSVB(NB,NZ,NY,NX)*WTRTRX)/WTPLTX 
      XFRC=AMIN1(CPOOLR(1,L,NZ,NY,NX),AMAX1(-WTRSVB(NB,NZ,NY,NX)
     2,FXFV(NS)*CPOOLD))
     ...
     2-WTRSBP(NB,NZ,NY,NX)*CPOOLR(1,L,NZ,NY,NX))/CPOOLT 
      XFRN=AMIN1(ZPOOLR(1,L,NZ,NY,NX),AMAX1(-WTRSBN(NB,NZ,NY,NX)
     2,FXFZ(NS)*ZPOOLD)) 
      XFRP=AMIN1(PPOOLR(1,L,NZ,NY,NX),AMAX1(-WTRSBP(NB,NZ,NY,NX)
     2,FXFZ(NS)*PPOOLD)) 
