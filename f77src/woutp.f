...
C
     ...
     2,(IFLGC(NZ,NY,NX),NZ=1,NP(NY,NX))
     3,(IDTH(NZ,NY,NX),NZ=1,NP(NY,NX))
      WRITE(26,97)I,IDATA(3),NP(NY,NX)
     2,((WTSTDG(M,NZ,NY,NX),M=1,4),NZ=1,NP(NY,NX))
     3,((WTSTDN(M,NZ,NY,NX),M=1,4),NZ=1,NP(NY,NX))
     4,((WTSTDP(M,NZ,NY,NX),M=1,4),NZ=1,NP(NY,NX))
     ...
     4,VPO4F(NZ,NY,NX)
      ...
      WRITE(26,95)I,IDATA(3),NZ,(IFLGD(NB,NZ,NY,NX),NB=1,NBR(NZ,NY,NX))
...
9945  CONTINUE
      ...
      WRITE(29,94)I,IDATA(3),NZ,(RUPPOP(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(RUNNBP(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(RUNNXP(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
      WRITE(29,94)I,IDATA(3),NZ,(RUPPBP(N,L,NZ,NY,NX),L=1,NJ(NY,NX))
